...
namespace Charlotte.Shooter.Players
{
    ...
    /// </summary>
    public class CharlottePlayer : Player
    {
        int counter = 0;
        int counter2 = 50;
        int counter3 = 0;
        ...
        protected override void PlayerInputUpdate(KeyboardState ks)
        {
            ...
            if (ks.IsKeyDown(Keys.Space) || ks.IsKeyDown(Keys.Enter))
            {
                ...
                if (counter2 >= 10 && PP > 0)
                {
                    ...
                    {
                        PP -= 1;
                        Shoot(new HomingPlayerProjectile(this.AssociatedLevel, this.Position));
                        counter2 = 0;
                    }
                }
            }
            else
            {
                ...
                if (counter > 10)
                {
                    Shoot(new CharlottePlayerProjectile(this.Position));
                    counter = 0;
                }
