...
{
    /// <summary>
    /// This class holds content that persists through the game. The content added here
    /// cannot be removed during the game's run.
    /// </summary>
    public static class PersistentContent
    {
        ...
        /// </summary>
        /// <param name="Name">The name of the SoundEffect.</param>
        /// <param name="Font">The SoundEffect itself.</param>
        ...
        /// </summary>
        /// <param name="Name">The name of the Song.</param>
        /// <param name="Font">The Song itself.</param>
        ...
        public static void AddVideo(string Name, Video Video)
        {
            Videos.Add(Name, Video);
        }
